...
<div style="text-align: center;">
  <img src="../assets/images/blogs/06-minerU/lightllm_multimodal.png"  style="zoom: 40%;" />
</div>

The diagram above illustrates the process of Lightllm multimodal inference. During integration, we observed that the TCP behavior of RPyC, as well as the strong coupling between ViT batch size and downstream scheduling, were major sources of latency—especially for small images and high-concurrency workloads.
...
<div style="text-align: center;">
  <img src="../assets/images/blogs/06-minerU/tcp_nodelay.png"  style="zoom: 40%;" />
</div>
